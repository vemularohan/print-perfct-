...
import { P as Phone, X, M as Menu, S as Search, F as FolderOpen, H as Heart, U as User, a as ShoppingCart, C as ChevronDown, b as Facebook, I as Instagram, L as Linkedin, T as Twitter, Y as Youtube } from "../_libs/lucide-react.mjs";
...
function Header() {
  const [promoOpen, setPromoOpen] = reactExports.useState(true);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-40 bg-background", children: [
    promoOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-primary text-primary-foreground text-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-page flex items-center justify-between py-2 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "truncate", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Buy More, Save More!" }),
        " Flat 5% OFF on Orders ₹10,000+  |  Code:",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono font-semibold", children: "SAVE5" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 shrink-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/help-centre", className: "hidden md:inline-flex items-center gap-1.5 hover:underline", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "h-3.5 w-3.5" }),
          " 02522-669393"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setPromoOpen(false), "aria-label": "Dismiss promo", className: "opacity-80 hover:opacity-100", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-3.5 w-3.5" }) })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b border-border bg-background shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-page flex items-center gap-4 py-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "lg:hidden p-2 -ml-2", onClick: () => setMobileOpen(true), "aria-label": "Open menu", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { className: "h-6 w-6" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2 shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-8 w-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 rounded-md bg-primary rotate-6" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 rounded-md bg-secondary -rotate-6 opacity-80" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-1.5 rounded-sm bg-background" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl font-bold text-primary tracking-tight", children: "VistaPrint" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex flex-1 max-w-2xl mx-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex w-full rounded-lg overflow-hidden border border-border focus-within:border-primary transition-colors", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "bg-primary text-primary-foreground px-5 inline-flex items-center justify-center hover:bg-primary/90", "aria-label": "Search", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "h-4 w-4" }) })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex items-center gap-1 ml-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/account", className: "hidden md:flex items-center gap-1.5 px-3 py-2 rounded-md hover:bg-muted text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(FolderOpen, { className: "h-5 w-5" }),
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden xl:inline", children: "Projects" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/account", className: "hidden md:flex items-center gap-1.5 px-3 py-2 rounded-md hover:bg-muted text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "h-5 w-5" }),
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden xl:inline", children: "Favourites" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/login", className: "hidden md:flex items-center gap-1.5 px-3 py-2 rounded-md hover:bg-muted text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "h-5 w-5" }),
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden xl:inline", children: "Account" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/cart", className: "flex items-center gap-1.5 px-3 py-2 rounded-md hover:bg-muted text-sm relative", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-1 inline-flex items-center justify-center rounded-full bg-primary text-primary-foreground text-xs h-5 min-w-5 px-1.5", children: "0" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: wrapRef, className: "relative border-t border-border hidden lg:block", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container-page", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1 overflow-x-auto no-scrollbar", children: NAV_TABS.map((tab) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              ...
              children: [
                tab.label,
                category ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "h-3 w-3 opacity-60" }) : null
              ]
            }
          ),
          category && isOpen ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-x-6 gap-y-2", children: category.subCategories.map((sub) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Link,
                  {
                    to: category.route,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 pt-4 border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: category.route, onClick: () => setOpenTab(null), className: "text-sm font-semibold text-primary hover:underline", children: [
                  "Shop all ",
                  category.name,
                  " →"
                ] }) })
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-4 border-b border-border", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-primary text-lg", children: "Menu" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setMobileOpen(false), "aria-label": "Close", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-5 w-5" }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "p-2", children: [
              NAV_TABS.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Link,
                {
                  to: tab.to,
                  onClick: () => setMobileOpen(false),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2 p-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/login", onClick: () => setMobileOpen(false), className: "px-3 py-2 rounded-md bg-muted text-center text-sm", children: "Account" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/cart", onClick: () => setMobileOpen(false), className: "px-3 py-2 rounded-md bg-primary text-primary-foreground text-center text-sm", children: "Cart" })
              ] })
            ] })
          ]
        }
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-footer text-footer-foreground mt-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-page py-14 grid gap-10 md:grid-cols-2 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-8 w-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 rounded-md bg-secondary rotate-6" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 rounded-md bg-accent -rotate-6 opacity-80" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl font-bold tracking-tight", children: "VistaPrint" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm opacity-80 max-w-xs", children: "Helping small businesses look professional with custom printing, design and merchandise." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 flex items-center gap-3", children: [Facebook, Instagram, Linkedin, Twitter, Youtube].map((Icon, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", "aria-label": "Social", className: "h-9 w-9 inline-flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "h-4 w-4" }) }, i)) })
      ] }),
      COLS.map((col) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-semibold mb-4", children: col.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5 text-sm opacity-80", children: col.links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: l.to, className: "hover:opacity-100 hover:underline", children: l.label }) }, l.label)) })
      ] }, col.title))
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-page flex flex-col md:flex-row items-center justify-between gap-3 py-5 text-xs opacity-80", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "© 2026 VistaPrint India. All rights reserved." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: ["VISA", "MC", "UPI", "PhonePe", "Razorpay"].map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2.5 py-1 rounded bg-white/10 font-medium tracking-wide", children: p }, p)) })
    ] }) })
  ] });
}
...
const $$splitComponentImporter$h = () => import("./stationery-BZN4Dsid.mjs");
...
const $$splitComponentImporter$g = () => import("./stamps-nNirvocM.mjs");
...
const $$splitComponentImporter$f = () => import("./signs-posters-BlB_TWk9.mjs");
...
const $$splitComponentImporter$e = () => import("./qr-code-generator-DFaRuTkG.mjs");
...
const $$splitComponentImporter$d = () => import("./photo-gifts-BGKg9-wR.mjs");
...
const $$splitComponentImporter$c = () => import("./pens-oyOctm9z.mjs");
...
const $$splitComponentImporter$b = () => import("./logomaker-BXOFdQcS.mjs");
...
const $$splitComponentImporter$a = () => import("./login-D9uH08n5.mjs");
...
const $$splitComponentImporter$9 = () => import("./labels-stickers-DlMihzkP.mjs");
...
const $$splitComponentImporter$8 = () => import("./help-centre-B4Mvs83R.mjs");
...
const $$splitComponentImporter$7 = () => import("./drinkware-CH01evA4.mjs");
...
const $$splitComponentImporter$6 = () => import("./design-services-BVnempzc.mjs");
...
const $$splitComponentImporter$5 = () => import("./clothing-bags-BfddadKI.mjs");
...
const $$splitComponentImporter$4 = () => import("./cart-CcEX-R7Z.mjs");
...
const $$splitComponentImporter$3 = () => import("./business-cards-BqoTUbBj.mjs");
...
const $$splitComponentImporter$2 = () => import("./account-BNU2WBF7.mjs");
...
const $$splitComponentImporter$1 = () => import("./index-ruMBuO1f.mjs");
...
const $$splitNotFoundComponentImporter = () => import("./product._slug-V9Y2zjZg.mjs");
const $$splitComponentImporter = () => import("./product._slug-QDP2M2i0.mjs");
