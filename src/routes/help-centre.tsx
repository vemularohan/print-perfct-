...
export const Route = createFileRoute("/help-centre")({
  head: () => ({
    meta: [
      { title: "Help Centre — SuriyanPrints" },
      { name: "description", content: "Find answers about orders, design, payment, delivery and returns. Or contact our support team." },
      { property: "og:title", content: "Help Centre — SuriyanPrints" },
      { property: "og:description", content: "Answers and support for SuriyanPrints customers." },
    ],
  }),
      ...
      <section className="bg-surface border-y border-border">
        <div className="container-page py-12 grid md:grid-cols-3 gap-6">
          {[
            ...
            { Icon: Mail, title: "Email support", body: "help@suriyanprints.in", sub: "Replies within 24 hours" },
