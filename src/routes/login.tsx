...
export const Route = createFileRoute("/login")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Sign In — VistaPrint India" },
      { property: "og:description", content: "Access your VistaPrint account." },
    ],
  }),
  component: LoginPage,
});
      ...
      <div className="hidden lg:flex items-center justify-center p-12 text-white" style={{ backgroundImage: "linear-gradient(135deg, hsl(205 80% 30%), hsl(200 80% 50%))" }}>
        <div className="max-w-md">
          <div className="flex items-center gap-2 mb-8">
            ...
            <span className="text-2xl font-bold">VistaPrint</span>
          </div>
