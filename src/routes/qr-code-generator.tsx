...
export const Route = createFileRoute("/qr-code-generator")({
  head: () => ({
    meta: [
      { title: "Free QR Code Generator — SuriyanPrints" },
      ...
      { property: "og:title", content: "Free QR Code Generator — SuriyanPrints" },
...
function QrPage() {
  const [text, setText] = useState("https://suriyanprints.in");
